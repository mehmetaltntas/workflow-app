...
import com.workflow.backend.dto.ConnectionRequestDto;
...
public class ConnectionController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Baglanti istegi gonderildi"),
    ...
    @PostMapping
    public ResponseEntity<ConnectionModel> sendConnectionRequest(@Valid @RequestBody ConnectionRequestDto request) {
    ...
    @GetMapping("/pending")
    public ResponseEntity<CollectionModel<ConnectionModel>> getPendingRequests() {
        List<ConnectionResponse> results = connectionService.getPendingRequests();
