...
import AssignedBoardsPage from "./pages/AssignedBoardsPage";
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            >
              ...
              <Route path="/boards/status/:statusSlug" element={<BoardStatusPage />} />
              ...
              <Route path="/assigned-boards" element={<AssignedBoardsPage />} />
